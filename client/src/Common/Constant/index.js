...
export const DANGER_SOCKET_SERVER_URL =
  process.env.REACT_APP_DANGER_SOCKET_SERVER_URL;

export const IMAGE_SOCKET_SERVER_URL =
  process.env.REACT_APP_IMAGE_SOCKET_SERVER_URL;
